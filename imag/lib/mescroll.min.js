 ...
 */
(function (a, b) {
    if (typeof define === "function") { define(b) } else { if (typeof module !== "undefined" && module.exports) { module.exports = b() } else { this[a] = b() } }
})("MeScroll", function () {
    var a = function (b, e) {
        var h = this; h.version = "1.4.0"; h.isScrollBody = (!b || b === "body"); h.scrollDom = h.isScrollBody ? document.body : h.getDomById(b);
        if (!h.scrollDom) { return }
        h.options = e || {};
    ...
    a.prototype.extendUpScroll = function (b) {
        ...
        a.extend(b, {
            ...
            offset: 100,
            toTop: {
                warpId: null, src: null, html: null, offset: 1000,
            ...
            empty: {
                warpId: null, icon: null,
                tip: "暂无相关数据~", btntext: "", btnClick: null, supportTap: false
            },
            clearId: null, clearEmptyId: null, hardwareClass: "mescroll-hardware", warpId: null, warpClass: "mescroll-upwarp",
            htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">加载中..</p>',
            htmlNodata: '<p class="upwarp-nodata">-- END --</p>',
            inited: function (d, e) { },
            showLoading: function (d, e) { e.innerHTML = d.optUp.htmlLoading },


            showNoMore: function (d, e) {
                e.innerHTML = d.optUp.htmlNodata;
                var footer=document.createElement("div");
                footer.innerHTML='<div class="footer footer1">' +  '<p>Copyright © 2022 南京理工大学智能媒体分析实验室.All rights reserved.</p>' + '</div>';
